...
export const MODAL_DATASET_TABLE_OPEN = 'MODAL_DATASET_OPEN';
export const MODAL_DATASET_TABLE_CLOSE = 'MODAL_DATASET_CLOSE';

export const MODAL_DATASET_CANDLE_OPEN = 'MODAL_DATASET_CANDLE_OPEN';
export const MODAL_DATASET_CANDLE_CLOSE = 'MODAL_DATASET_CANDLE_CLOSE';
